...
- PLAN = APPROVED / FROZEN（R1）；T00、T01、T02 完成。M1 Foundation 與最小 Opportunity/Evidence substrate implementation、acceptance、OpenSpec sync/archive 已完成；目前狀態以本節與 active `m2-intelligence-vertical-slice` change 為準；M2 planning repair 與 read-only planning review 尚待完成，完整 M1 product-domain workflows 尚未實作。
