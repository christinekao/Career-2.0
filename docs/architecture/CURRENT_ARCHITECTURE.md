...
狀態為 `PLANNING_ACCEPTED / BATCH_1_ACCEPTED / BATCH_2_IMPLEMENTATION_COMPLETE_REPAIRED_PENDING_FINAL_ACCEPTANCE / IN_PROGRESS`。它只規劃單一
