...
This baseline records approved target behavior for the minimal offline local
application foundation. It does not claim that the foundation is implemented;
real Career 2.0 data remains user-owned and outside the source repository.
